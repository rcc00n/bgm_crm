...
class MerchListingSourceTests(SimpleTestCase):
    ...
    def test_prefers_store_merch_products_when_available(
        self,
    ...
    @patch("accounts.views.get_printful_merch_feed")
    @patch("accounts.views._build_store_merch_products")
    def test_falls_back_to_printful_feed_when_store_merch_products_are_empty(
        self,
        build_store_merch_products,
        get_printful_merch_feed,
    ...
    @patch("accounts.views.get_printful_merch_feed")
    @patch("accounts.views._build_store_merch_products")
    def test_surfaces_printful_error_when_no_store_or_feed_products(
        self,
        build_store_merch_products,
        get_printful_merch_feed,
    ):
