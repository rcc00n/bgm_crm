...
ADMIN_SIDEBAR_GROUP_ALIASES = {
    ...
    "system__access-control": "reference-setup__crm-vehicles",
    ...
    "system__people-access": "reference-setup__crm-vehicles",
    ...
    "reporting-access__people-access": "reference-setup__crm-vehicles",
}
