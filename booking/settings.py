        ...
        "groups": [
            {
                ...
                "items": [
                    ...
                    {"model": "core.MasterAvailability", "label": "Staff Availability"},
        ...
        "groups": [
            {
                ...
                "items": [
                    ...
                    {"model": "core.DealerApplication", "label": "Dealer Applications"},
                    {
                        "label": "Dealer Profiles",
                        "href": "/admin/core/userprofile/?is_dealer__exact=1",
                        "icon": "fas fa-id-badge",
                        "active_patterns": ["admin:core_userprofile_"],
        ...
        "groups": [
            {
                ...
                "items": [
                    ...
                    {"model": "core.SiteHoursSettings", "label": "Site Hours Settings"},
...
ADMIN_SIDEBAR_GROUP_ALIASES = {
    ...
    "operations__payments": "operations__scheduling-shop",
    "operations__analytics": "reporting-access__insights-qa",
    "clients__client-records": "customers-sales__client-hub",
    "storefront__catalog": "customers-sales__catalog-merch-fulfillment",
    "storefront__vehicles-fitment": "customers-sales__catalog-merch-fulfillment",
    "storefront__orders": "customers-sales__catalog-merch-fulfillment",
    "website-content__branding-fonts": "website-marketing__content-brand-assets",
    "website-content__page-copy": "website-marketing__content-brand-assets",
    "website-content__messaging": "website-marketing__email-campaigns",
    "system__access-control": "operations__scheduling-shop",
    "reference-setup__catalog-reference": "operations__scheduling-shop",
    "operations__front-desk": "operations__scheduling-shop",
    "operations__shop-setup": "operations__scheduling-shop",
    "operations__payments-offers": "operations__scheduling-shop",
    "operations__payments-promotions": "operations__scheduling-shop",
    "clients__clients-leads": "customers-sales__client-hub",
    "clients__dealer-program": "customers-sales__client-hub",
    "storefront__products-merch": "customers-sales__catalog-merch-fulfillment",
    "storefront__store-setup": "customers-sales__catalog-merch-fulfillment",
    "storefront__orders-fitment": "customers-sales__catalog-merch-fulfillment",
    "storefront__store-maintenance": "customers-sales__catalog-merch-fulfillment",
    "website-content__page-editor": "website-marketing__content-brand-assets",
    "website-content__brand-assets": "website-marketing__content-brand-assets",
    "website-content__email-messaging": "website-marketing__email-campaigns",
    "insights__dashboards-qa": "reporting-access__insights-qa",
    "system__people-access": "operations__scheduling-shop",
    "reference-setup__booking-reference": "operations__scheduling-shop",
    "reference-setup__payment-reference": "operations__scheduling-shop",
    "reference-setup__crm-reference": "operations__scheduling-shop",
    "reference-setup__vehicle-directory": "operations__scheduling-shop",
    "reference-setup__crm-vehicles": "operations__scheduling-shop",
    "customers-sales__catalog-merch": "customers-sales__catalog-merch-fulfillment",
    "customers-sales__orders-fulfillment": "customers-sales__catalog-merch-fulfillment",
    "website-marketing__page-content": "website-marketing__content-brand-assets",
    "website-marketing__brand-assets": "website-marketing__content-brand-assets",
    "reference-setup__booking-payments": "operations__scheduling-shop",
    "reporting-access__people-access": "operations__scheduling-shop",
}
...
JAZZMIN_SETTINGS = {
    ...
    "icons": {
        ...
        "core.SiteHoursSettings": "fas fa-business-time",
